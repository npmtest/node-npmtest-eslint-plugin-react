...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-eslint-plugin-react/node_modules/eslint-plugin-react/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-eslint-plugin-react/node_modules/eslint-plugin-react/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-eslint-plugin-react/node_modules/eslint-plugin-react/</a> &#187; index.js</div>
</div>
<div class="body">
...
function configureAsError(rules) {
  var result = {};
  for (var key in rules) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!has(rules, key)) {
